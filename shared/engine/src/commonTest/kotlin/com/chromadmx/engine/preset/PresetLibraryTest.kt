...
class PresetLibraryTest {
    ...
    fun testListAndFilter() {
        ...
        val builtInCount = builtInPresets().size
        val builtInTechno = builtInPresets().count { it.genre == Genre.TECHNO }
        val builtInHouse = builtInPresets().count { it.genre == Genre.HOUSE }
