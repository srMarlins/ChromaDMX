...
## 2024-05-24 - OS Keyboard Caching Vulnerability
**Vulnerability:** Wi-Fi password field masked visually but cached by OS keyboard.
**Learning:** Compose's PasswordVisualTransformation only masks text on screen. Without explicit KeyboardOptions, the OS keyboard may cache the password in the dictionary or suggest autocomplete.
**Prevention:** Always pair PasswordVisualTransformation with KeyboardOptions(keyboardType = KeyboardType.Password, autoCorrectEnabled = false) on all secret text fields.
